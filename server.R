...
shinyServer(function(input, output, session) {
  ...
  # Render the initial plot of the data
  ...
  # Set algorithm parameters, define functions, and run algorithm
  # output$distributionPlot <- renderPlot({
  ...
  #           plot(
  #             df,
  #             main = "Initial Distribution Means & Covariances",
  #             cex = .5,
  #             las = 1,
  #             bty = "l",
  #             pch = 19,
  ...
  #             lines(
  #               ellipse(COR, centre = as.numeric(kMean[k, ]), level = 0.95),
  #               col = graphColor[k],
  #               lwd = 2
  #             )
  #           }
  ...
  #           incProgress(1 / 20, detail = paste("Doing part", t))
  #
  #           # Plot the means & covariances for the clusters
  #           plot(
  #             df,
  #             main = paste(
  #               "Distribution Means & Covariances for Iteration ",
  #               t,
  #               sep = ""
  #             ),
  #             cex = .5,
